...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
		...
		TextField stopIteration = new TextField();   
		TextField tolerance = new TextField();   
		Button nextButton = new Button("Next");
		Button nextAButton = new Button("Next align");
		Button againButton = new Button("Again");
		CheckBox ccw = new CheckBox("CCW on/off"); 
		CheckBox poh = new CheckBox("Place over hole on/off"); 
		CheckBox intersectionPoint = new CheckBox("Show intersection points"); 
		Label sizeOfDisk = new Label("Size of disk: ");
		Label radiusOfDisk = new Label("Radius of disk: ");
        ...
        nextAButton.setOnAction(new EventHandler<ActionEvent>() {
